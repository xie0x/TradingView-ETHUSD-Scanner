...
const formatReadme = (data) => {
  ...
  formattedReadme.push('# TradingView ETHUSD Scanner (1H)')
  ...
  formattedReadme.push('ETHUSD recommendation scanner based on real-time TradingView data Scanner API')
...
const main = async () => {
  try {
    ...
    await fs.writeJson('dataeth.json', { updated: formattedDate, data }, { spaces: 2 })

    const historyFile = 'ethprice_history.json'
    let history = []
